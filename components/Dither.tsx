...
const WrappedRetro = wrapEffect(RetroEffectImpl) as unknown as React.ComponentType<{
  colorNum: number;
  pixelSize: number;
...
const RetroEffect = forwardRef<unknown, RetroEffectProps>(function RetroEffect(
  { colorNum, pixelSize },
  ref
) {
...
function DitheredWaves({
  ...
  const waveUniformsRef = useRef<WaveUniforms>({
    ...
    waveColor: new THREE.Uniform(
      new THREE.Color(waveColor[0], waveColor[1], waveColor[2])
    ),
